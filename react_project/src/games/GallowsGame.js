...
//
//     if(haslo == haslo1)
//         document.getElementById("alfabet").innerHTML = "ROZJEBALES MORDO WYGRALES ZYCIE <br> Haslo: "+ haslo +'<br>' +
//             '<span class="reset" onclick="location.reload()">JESZCZE RAZ?</span>'
//
//     //przegrana
//     if(ile_skuch >= 9)
//         document.getElementById("alfabet").innerHTML = "PRZEGRALES ZYCIE <br> Haslo: "+ haslo +'<br>' +
//             '<span class="reset" onclick="location.reload()">JESZCZE RAZ?</span>'
// }
//
